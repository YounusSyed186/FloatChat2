...
ARGO_MEASUREMENTS_SCHEMA = {
    ...
    'columns': {
        ...
        'salinity': 'DECIMAL(10, 4) NOT NULL',
        'depth': 'DECIMAL(10, 4) NULL',
        'oxygen': 'DECIMAL(10, 4) NULL',
        'nitrate': 'DECIMAL(10, 4) NULL',
        'ph': 'DECIMAL(10, 4) NULL',
        'chlorophyll': 'DECIMAL(10, 4) NULL',
...
def validate_measurement_data(measurement: Dict[str, Any]) -> bool:
    ...
    optional_ranges = {
        ...
        'nitrate': (0, 50),       # micromole/kg
        'ph': (6, 9),             # typical ocean pH
        'chlorophyll': (0, 50)    # mg/m3
    }
    for param, (min_val, max_val) in optional_ranges.items():
        if measurement.get(param) is not None:
            val = float(measurement[param])
